...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style.css">
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="assets/img/kamu.png">
	<link rel="icon" type="image/png" sizes="96x96" href="assets/img/gambar_2.png">

</head>
<body style="background: url(img/kamu.jpg); background-size: cover;">
<div class="container">
...
<h3 style="text-align: center;" class="dodger black-text">Login</h3>
	<form method="POST">
